...
<<<<<<< HEAD
ADMIN_VERB(debug_hallucination_weighted_list_per_type, R_DEBUG, FALSE, "Show Hallucination Weights", "View the weight of each hallucination subtype in the random weighted list.", ADMIN_CATEGORY_DEBUG)
=======
