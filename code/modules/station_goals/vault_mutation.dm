...
<<<<<<< HEAD
/datum/mutation/plasmocile/proc/apply_buff(obj/item/organ/internal/lungs/our_lungs)
	our_lungs.plas_breath_dam_min *= 0
	our_lungs.plas_breath_dam_max *= 0

/datum/mutation/plasmocile/proc/remove_buff(obj/item/organ/internal/lungs/our_lungs)
=======
