...
<<<<<<< HEAD
ADMIN_VERB(test_movable_UI, R_DEBUG, FALSE, "Spawn Movable UI Object", "Spawn a movable UI object for testing.", ADMIN_CATEGORY_DEBUG)
=======
...
ADMIN_VERB(test_snap_ui, R_DEBUG, FALSE, "Spawn Snap UI Object", "Spawn a snap UI object for testing.", ADMIN_CATEGORY_DEBUG)
=======
